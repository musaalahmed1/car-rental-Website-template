<?php
    ...
    <div class="text-center">
        <p class="display-4 fw-bold text-primary">Bilgiler Güncellendi</p>
        <a href="adminListCars.php" class="btn btn-success btn-lg mt-4 px-5 py-2">Listelemeye Geri Dön</a>
    </div>
</div>
