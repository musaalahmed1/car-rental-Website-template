<?php
    ...
    <div class="text-center">
        <p class="display-4 fw-bold text-success">Kiralama İşleminiz Gerçekleşti</p>
        <p class="text-muted fs-5">Hesabım kısmından görüntüleyebilirsiniz!</p>
        <a href="profile.php" class="btn btn-primary mt-3 px-5 py-2">Hesabım</a>
    </div>
</div>
